...
runs: 20:35 / 04:35 / 12:35 NL-tijd) krijgt het volledige
...
(20:35/04:35/12:35) bij elkaar horen; die +2 uur klopt in beide seizoenen
...
# De 3 runs (20:35 / 04:35 / 12:35 NL-tijd) horen bij DEZELFDE
# kalenderdag, maar DataUpdatedAt staat in UTC (20:35 NL = 18:35 UTC in de
...
def run_day_key(dt):
    ...
    Zo horen de 3 runs van één NL-dag (20:35/04:35/12:35) bij dezelfde dag,
...
def main(argv=None):
    ...
    p.add_argument("--ignore-same-day", action="store_true",
                   help="zet de 'max. 1x per dag'-regel UIT. Standaard wordt "
                        ...
                        "runs 20:35/04:35/12:35 NL) al is ververst "
    ...
    # runs van één NL-dag (20:35/04:35/12:35) horen zo bij elkaar. Een game
